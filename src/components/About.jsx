  ...
  return (
    <section id="about" className="about section-bg">
      <div className="container-fluid">
        ...
        <div className="row">
          <div className="col-xl-5 col-lg-6 image-box d-flex justify-content-center align-items-stretch position-relative"></div>
          <div className="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h3>
              Enhancing Accessibility for the visually impaired by introducing a new app called
              "AudioSight" to the Community.
            </h3>

            <p>
              Our project focuses on revolutionizing accessibility for the visually impaired community
              through the utilization of the AudioSight App. We have chosen this application for its
